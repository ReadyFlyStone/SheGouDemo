...
#define isLogin [FWUserManager shared].isLogined
#define curUser [FWUserManager shared].curUserInfo
#define userManager [FWUserManager shared]
/**
 包含用户相关服务
 */
@interface FWUserManager : NSObject
//单例
SINGLETON_FOR_HEADER(FWUserManager)
