...
#import "FWIMManager.h"

//@interface FWIMManager()<NIMLoginManagerDelegate,NIMChatManagerDelegate>
@interface FWIMManager()

@end

@implementation FWIMManager

SINGLETON_FOR_CLASS(FWIMManager);
...
//            XPLog("IM 退出成功");
//        }else{
//            XPLog("IM 退出失败 %@",error.localizedDescription);
//        }
//    }];
}
